...
export class LeaderBoardLeadingComponent implements OnInit {
  ...
  leaderBoardCheck(){
    ...
    this.leaderboardPlayers = presentationLevelPlayer.sort((a,b)=> b.score - a.score);
    var slideLevelPlayer=this.template?.leaderBoard?.slidesQuizPlayer;
    var totalQuizSlide = slideLevelPlayer;
    var i = 1;
